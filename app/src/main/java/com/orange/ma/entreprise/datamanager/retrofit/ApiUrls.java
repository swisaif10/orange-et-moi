...
public class ApiUrls {
    ...
    public static final String BASE_URL = "http://orangepro.mobiblanc.com/orange_pro/api/public/";

    public static final String CHECK_VERSION_URL = "{locale}/api/version-control/check";
    public static final String GET_CGU_URL = "{locale}/api/html-description/show";
